...
(async () => {
  ...
  for (const s of ['verify_poarta.js', 'tenant_smoke.js', 'rbac_smoke.js', 'catalog_smoke.js', 'verify_receptie.js', 'verify_pornire.js', 'verify_conexiuni.js', 'verify_copii.js', 'verify_can_flags.js', 'verify_io_modal.js', 'verify_io_format.js', 'verify_consum.js', 'verify_tacho.js', 'verify_tacho_api.js', 'verify_mobile_tacho.js', 'verify_etransport.js', 'verify_tollro.js', 'verify_tollro_flota.js', 'verify_setari.js', 'verify_aparate.js', 'verify_istoric.js', 'verify_adrese.js', 'verify_roluri.js', 'verify_preferinte.js', 'verify_companii.js', 'verify_contracte.js', 'verify_lipsuri.js', 'verify_drum.js', 'verify_factura.js', 'verify_pastrare.js', 'verify_neplata.js', 'verify_montaj.js', 'verify_tarife.js', 'verify_acasa.js', 'verify_insight_panou.js', 'verify_campuri.js', 'verify_statistici_flota.js', 'verify_fara_planuri.js', 'verify_utilizatori.js', 'verify_dispozitive.js', 'verify_arhiva.js', 'verify_inventar.js', 'verify_tacho_fondator.js', 'verify_etransport_fondator.js', 'verify_ofertare.js']) {
    console.log('\n=== ' + s + ' ===');
