...
(async () => {
  ...
  for (const s of ['tenant_smoke.js', 'rbac_smoke.js', 'catalog_smoke.js', 'verify_can_flags.js', 'verify_io_modal.js', 'verify_io_format.js', 'verify_consum.js', 'verify_tacho.js', 'verify_tacho_api.js', 'verify_mobile_tacho.js', 'verify_etransport.js', 'verify_tollro.js', 'verify_tollro_flota.js', 'verify_setari.js', 'verify_aparate.js', 'verify_istoric.js']) {
    console.log('\n=== ' + s + ' ===');
