...
(async () => {
  ...
  ok((await req(aA, 'POST', '/api/login', { username: uA, password: 'Curcubeu7Vara', full_name: 'Admin A' })).status === 200, 'admin A login');
  ok((await req(aB, 'POST', '/api/login', { username: uB, password: 'Curcubeu7Vara', full_name: 'Admin B' })).status === 200, 'admin B login');
